...
## 1. Custom kernel — `linux-tkg` 7.2.4‑skillfishos
...
Recipe and patches: [`kernel-build/`](../kernel-build/). Build instructions: [BUILD.md](BUILD.md). Prebuilt `.deb`: [Releases](../../../releases/tag/kernel-7.2.4-skillfishos). Two flavours ship: **main** (`-march=znver2`, BC‑250) and **x64** (`-march=x86-64`, any other x64 box). Measured against 7.0.11 and 7.1.7 the kernels are **identical within ±2%** — the update is for maintenance and security, not speed.
