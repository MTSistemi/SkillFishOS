...
```sh
sudo dpkg -i linux-image-7.2.6-skillfishos_*.deb linux-headers-7.2.6-skillfishos_*.deb
sudo apt-mark hold linux-image-7.2.6-skillfishos linux-headers-7.2.6-skillfishos
sudo update-grub
```

A prebuilt build is also published under [Releases](../../../releases/tag/kernel-7.2.6-skillfishos).
