 ...
 *
 * ⚠️ Ucraino e russo NON sono rivisti da madrelingua: li ha scritti il team.
 * Il polacco invece e' di Cyryl Sochacki. Correzioni benvenute.
 */
Presentation {
    id: presentation

    // it / pl / uk / ru / en, con l'inglese come base
