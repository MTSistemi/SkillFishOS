...
> Obraz **26.06.5 «Aetherium»** jest dostępny — pobierz go ze strony [Pobieranie](/pl/download). Startuje po **angielsku**, żeby był uniwersalny, a język i układ klawiatury wybierasz podczas instalacji.
