...
![раздел Состояние в SkillFishOS Control Center](/img/control-center-stato.png)
...
![раздел Тюнер в SkillFishOS Control Center](/img/control-center-tuner.png)
...
![раздел Монитор в SkillFishOS Control Center](/img/control-center-monitor.png)
...
![раздел Игры в SkillFishOS Control Center](/img/control-center-giochi.png)
...
![раздел ИИ в SkillFishOS Control Center](/img/control-center-ai.png)

Движок это **Unsloth Studio**: он запускает модели GGUF через llama.cpp на бэкенде **Vulkan**, который на gfx1013 в BC-250 единственный ускоренный путь, потому что ROCm её не поддерживает. Измерено на плате с Qwen3-1.7B Q4_K_M: 210 токенов в секунду против 41 на одном CPU.
...
## Остальные разделы, одним взглядом

Вот как они выглядят, когда их открываешь.

![раздел Вентилятор в SkillFishOS Control Center](/img/control-center-ventola.png)

![раздел Профили в SkillFishOS Control Center](/img/control-center-profili.png)

![раздел Ядро в SkillFishOS Control Center](/img/control-center-kernel.png)

![раздел Эмуляторы в SkillFishOS Control Center](/img/control-center-emulatori.png)

![раздел Консоль в SkillFishOS Control Center](/img/control-center-console.png)

![раздел ISO в SkillFishOS Control Center](/img/control-center-iso.png)
