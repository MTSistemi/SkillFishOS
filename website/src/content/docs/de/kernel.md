...
Der Kernel von SkillFishOS trägt die Fassung **`7.2.4-skillfishos`** (die Reihen 7.0 und 7.1 werden nicht mehr gepflegt). Zusätzlich zu den üblichen linux-tkg-Patches enthält er:
