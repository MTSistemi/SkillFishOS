...
> The **26.06.5 «Aetherium»** ISO is available — download it from the [Download](/en/download) page. It boots in **English** to stay universal and lets you pick your language and keyboard during installation.
...
- tune the hardware with the [Tuner](/en/docs/control-center) if you wish.
