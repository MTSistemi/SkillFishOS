...
Le noyau de SkillFishOS est en version **`7.2.4-skillfishos`** (les séries 7.0 et 7.1 sont arrivées en fin de vie). En plus des correctifs habituels de linux-tkg il contient :
