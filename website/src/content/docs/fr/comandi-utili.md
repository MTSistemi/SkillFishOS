...
> Sur la BC-250 la commande de la fréquence ne passe **pas** par le sysfs habituel d'amdgpu, mais par le **gouverneur SMU**. Changez les valeurs depuis le [Tuner](/fr/docs/control-center), pas à la main.
