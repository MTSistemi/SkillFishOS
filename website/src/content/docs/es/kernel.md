...
El núcleo de SkillFishOS es la versión **`7.2.4-skillfishos`** (las series 7.0 y 7.1 están fuera de mantenimiento). Sobre los parches estándar de linux-tkg incluye:
