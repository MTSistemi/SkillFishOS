...
Il kernel di SkillFishOS è la versione **`7.2.4-skillfishos`** (le serie 7.0 e 7.1 non ricevono più aggiornamenti). Oltre alle patch standard di linux-tkg include:
