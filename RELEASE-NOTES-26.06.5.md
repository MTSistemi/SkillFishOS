# SkillFishOS 26.06.5 "Aetherium" — media respin
...
This is the release to use if you are on **26.06.3**. A 26.06.4 candidate was built and
then held back: checking it before publishing turned up an installer fix that had only
been applied to half of our build pipeline. That is described below, because it is the
most useful thing in these notes.
...
```
sha256sum -c SkillFishOS-26.06.5-Aetherium-<edition>-amd64.iso.sha256
```
