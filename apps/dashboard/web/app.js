...
const STR = {
  ...
  x_open: { it: "Apri ", en: "Open ", pl: "Otwórz ", uk: "Відкрити ", ru: "Открыть ", es: "Abrir ", pt: "Abrir ", de: "Öffnen " },
  ...
  x_ctx: { it: "Contesto", en: "Context", pl: "Kontekst", uk: "Контекст", ru: "Контекст", es: "Contexto", pt: "Contexto", de: "Kontext" },
  x_gttcap: { it: "Cap GTT", en: "GTT cap", pl: "Limit GTT", uk: "Ліміт GTT", ru: "Предел GTT", es: "Límite del GTT", pt: "Limite do GTT", de: "GTT-Grenze" },
  x_unlocked: { it: "sbloccato", en: "unlocked", pl: "odblokowane", uk: "розблоковано", ru: "разблокировано", es: "desbloqueado", pt: "liberado", de: "freigegeben" },
  ...
  x_applying: { it: "Applico…", en: "Applying…", pl: "Stosowanie…", uk: "Застосування…", ru: "Применяю…", es: "Aplicando…", pt: "Aplicando…", de: "Wird angewendet…" },
  ...
  x_updated: { it: "Aggiornato", en: "Updated", pl: "Zaktualizowano", uk: "Оновлено", ru: "Обновлено", es: "Actualizado", pt: "Atualizado", de: "Aktualisiert" },
  x_localai: { it: "AI locale", en: "On-device AI", pl: "SI lokalna", uk: "Локальний ШІ", ru: "Локальный ИИ", es: "IA local", pt: "IA local", de: "Örtliche KI" },
  ...
  x_engine: { it: "Motore", en: "Engine", pl: "Silnik", uk: "Рушій", ru: "Движок", es: "Motor", pt: "Motor", de: "Motor" },
  x_accel: { it: "Accelerazione", en: "Acceleration", pl: "Akceleracja", uk: "Прискорення", ru: "Ускорение", es: "Aceleración", pt: "Aceleração", de: "Beschleunigung" },
  ...
  x_save: { it: "Salva", en: "Save", pl: "Zapisz", uk: "Зберегти", ru: "Сохранить", es: "Guardar", pt: "Salvar", de: "Sichern" },
  ...
  x_user: { it: "Utente", en: "User", pl: "Użytkownik", uk: "Користувач", ru: "Пользователь", es: "Usuario", pt: "Usuário", de: "Benutzer" },
  ...
  x_chat: { it: "Chat", en: "Chat", pl: "Czat", uk: "Чат", ru: "Чат", es: "Chat", pt: "Chat", de: "Chat" },
  ...
  x_pull: { it: "Scarica", en: "Pull", pl: "Pobierz", uk: "Завантажити", ru: "Скачать", es: "Descargar", pt: "Baixar", de: "Holen" },
  ...
  x_node: { it: "Nodo", en: "Node", pl: "Węzeł", uk: "Вузол", ru: "Узел", es: "Nodo", pt: "Nó", de: "Knoten" },
  x_state: { it: "Stato", en: "Status", pl: "Stan", uk: "Стан", ru: "Состояние", es: "Estado", pt: "Estado", de: "Zustand" },
  x_nets: { it: "Reti", en: "Networks", pl: "Sieci", uk: "Мережі", ru: "Сети", es: "Redes", pt: "Redes", de: "Netze" },
  x_join: { it: "Entra", en: "Join", pl: "Dołącz", uk: "Приєднатися", ru: "Присоединиться", es: "Unirse", pt: "Entrar", de: "Beitreten" },
  ...
  m_telem: { it: "Telemetria", en: "Telemetry", pl: "Telemetria", uk: "Телеметрія", ru: "Телеметрия", es: "Telemetría", pt: "Telemetria", de: "Messwerte" },
  ...
  m_ctrl: { it: "Controlli", en: "Controls", pl: "Sterowanie", uk: "Керування", ru: "Управление", es: "Controles", pt: "Controles", de: "Steuerung" },
  ...
  m_launch: { it: "Avvio app", en: "Launcher", pl: "Uruchamianie aplikacji", uk: "Запуск програм", ru: "Запуск программ", es: "Lanzador", pt: "Lançador", de: "Starter" },
  m_term: { it: "Terminale", en: "Terminal", pl: "Terminal", uk: "Термінал", ru: "Терминал", es: "Terminal", pt: "Terminal", de: "Terminal" },
  ...
  w_move: { it: "Sposta", en: "Move", pl: "Przenieś", uk: "Перемістити", ru: "Переместить", es: "Mover", pt: "Mover", de: "Verschieben" },
  w_coll: { it: "Comprimi", en: "Collapse", pl: "Zwiń", uk: "Згорнути", ru: "Свернуть", es: "Plegar", pt: "Recolher", de: "Einklappen" },
  w_close: { it: "Chiudi", en: "Close", pl: "Zamknij", uk: "Закрити", ru: "Закрыть", es: "Cerrar", pt: "Fechar", de: "Schließen" },
  ...
  user: { it: "Utente", en: "User", pl: "Użytkownik", uk: "Користувач", ru: "Пользователь", es: "Usuario", pt: "Usuário", de: "Benutzer" }, pass: { it: "Password", en: "Password", pl: "Hasło", uk: "Пароль",
                                                                                  ru: "Пароль", es: "Contraseña", pt: "Senha", de: "Kennwort" },
  enter: { it: "Entra", en: "Sign in", pl: "Zaloguj się", uk: "Увійти", ru: "Войти", es: "Entrar", pt: "Entrar", de: "Anmelden" }, denied: { it: "accesso negato", en: "access denied", pl: "odmowa dostępu", uk: "доступ заборонено",
                                                                                    ru: "доступ запрещён", es: "acceso denegado", pt: "acesso negado", de: "Zugang verweigert" },
  logout: { it: "Esci", en: "Log out", pl: "Wyloguj", uk: "Вийти", ru: "Выйти", es: "Salir", pt: "Sair", de: "Abmelden" }, neterr: { it: "errore di rete", en: "network error", pl: "błąd sieci", uk: "помилка мережі",
                                                                               ru: "ошибка сети", es: "error de red", pt: "erro de rede", de: "Netzfehler" },
  copied: { it: "Copiato", en: "Copied", pl: "Skopiowano", uk: "Скопійовано", ru: "Скопировано", es: "Copiado", pt: "Copiado", de: "Kopiert" }, done: { it: "fatto", en: "done", pl: "gotowe", uk: "готово",
                                                                                        ru: "готово", es: "hecho", pt: "pronto", de: "fertig" },
  g_monitor: { it: "Monitoraggio", en: "Monitoring", pl: "Monitorowanie", uk: "Моніторинг", ru: "Наблюдение", es: "Vigilancia", pt: "Monitoramento", de: "Überwachung" }, g_control: { it: "Controllo", en: "Control", pl: "Sterowanie", uk: "Керування",
                                                                                                           ru: "Управление", es: "Control", pt: "Controle", de: "Steuerung" },
  g_remote: { it: "Accesso remoto", en: "Remote access", pl: "Dostęp zdalny", uk: "Віддалений доступ", ru: "Доступ издалека", es: "Acceso remoto", pt: "Acesso remoto", de: "Fernzugriff" }, g_ai: { it: "Intelligenza artificiale", en: "AI", pl: "SI", uk: "ШІ",
                                                                                                                 ru: "ИИ", es: "IA", pt: "IA", de: "KI" },
  g_other: { it: "Altro", en: "Other", pl: "Inne", uk: "Інше", ru: "Прочее", es: "Otros", pt: "Outros", de: "Sonstiges" },
  // telemetry
  t_temp: { it: "Temperatura", en: "Temperature", pl: "Temperatura", uk: "Температура", ru: "Температура", es: "Temperatura", pt: "Temperatura", de: "Temperatur" }, t_load: { it: "Carico", en: "Load", pl: "Obciążenie", uk: "Навантаження",
                                                                                                    ru: "Нагрузка", es: "Carga", pt: "Carga", de: "Last" },
  t_freq: { it: "Frequenza", en: "Frequency", pl: "Częstotliwość", uk: "Частота", ru: "Частота", es: "Frecuencia", pt: "Frequência", de: "Takt" }, t_pow: { it: "Potenza", en: "Power", pl: "Moc", uk: "Потужність",
                                                                                             ru: "Мощность", es: "Potencia", pt: "Potência", de: "Leistungsaufnahme" },
  t_volt: { it: "Voltaggio", en: "Voltage", pl: "Napięcie", uk: "Напруга", ru: "Напряжение", es: "Voltaje", pt: "Tensão", de: "Spannung" }, t_fan: { it: "Ventola", en: "Fan", pl: "Wentylator", uk: "Вентилятор",
                                                                                      ru: "Вентилятор", es: "Ventilador", pt: "Ventoinha", de: "Lüfter" }, live: { it: "live", en: "live", pl: "na żywo", uk: "наживо",
  ...
  c_off: { it: "off", en: "off", pl: "wył.", uk: "вимк.", ru: "выкл.", es: "apag.", pt: "deslig.", de: "aus" }, c_avg: { it: "med", en: "avg", pl: "śr.", uk: "сер.", ru: "сред.", es: "med.", pt: "méd.", de: "Mittel" }, c_online: { it: "attivi", en: "online", pl: "aktywne", uk: "активні",
                                                                                                                                ru: "активны", es: "activos", pt: "ativos", de: "aktiv" },
  // status
  s_you: { it: "Sei connesso a", en: "Connected to", pl: "Połączono z", uk: "З'єднано з",
           ru: "Вы подключены к", es: "Estás conectado a", pt: "Você está conectado a", de: "Du bist verbunden mit" }, s_host: { it: "Host", en: "Host", pl: "Host", uk: "Вузол",
                                                                                                      ru: "Узел", es: "Equipo", pt: "Máquina", de: "Rechner" },
  s_ip: { it: "IP (rotta)", en: "IP (route)", pl: "IP (trasa)", uk: "IP (маршрут)", ru: "IP (маршрут)", es: "IP (ruta)", pt: "IP (rota)", de: "IP (Route)" }, s_kernel: { it: "Kernel", en: "Kernel", pl: "Jądro", uk: "Ядро",
                                                                                                  ru: "Ядро", es: "Núcleo", pt: "Kernel", de: "Kernel" },
  s_up: { it: "Uptime", en: "Uptime", pl: "Czas działania", uk: "Час роботи", ru: "Время работы", es: "Tiempo encendido", pt: "Tempo ligado", de: "Laufzeit" }, s_cu: { it: "CU attive", en: "Active CUs", pl: "Aktywne CU", uk: "Активні CU",
                                                                                        ru: "Активные CU", es: "CU activas", pt: "CU ativas", de: "Aktive CU" }, s_ram: { it: "RAM", en: "RAM", pl: "RAM", uk: "RAM",
                                                                                                                                                                          ru: "ОЗУ", es: "RAM", pt: "RAM", de: "RAM" },
  s_disk: { it: "Disco /", en: "Disk /", pl: "Dysk /", uk: "Диск /", ru: "Диск /", es: "Disco /", pt: "Disco /", de: "Platte /" }, s_frz: { it: "Freeze rilevati", en: "Freezes detected", pl: "Wykryte zawieszenia", uk: "Виявлені зависання",
                                                                                ru: "Замечено зависаний", es: "Cuelgues detectados", pt: "Travamentos detectados", de: "Erkannte Einfrierer" },
  // tuner
  c_preset: { it: "Preset", en: "Presets", pl: "Profile", uk: "Профілі", ru: "Наборы", es: "Perfiles", pt: "Perfis", de: "Vorgaben" }, c_gov: { it: "Governor GPU", en: "GPU governor", pl: "Regulator GPU", uk: "Регулятор ГП",
                                                                                    ru: "Регулятор видеоядра", es: "Gobernador de la GPU", pt: "Governador da GPU", de: "Governor der GPU" },
  c_bal: { it: "Bilanciato", en: "Balanced", pl: "Zrównoważony", uk: "Збалансований", ru: "Уравновешенный", es: "Equilibrado", pt: "Equilibrado", de: "Ausgewogen" }, c_perf: { it: "Performance", en: "Performance", pl: "Wydajność", uk: "Продуктивність",
                                                                                                  ru: "Производительность", es: "Rendimiento", pt: "Desempenho", de: "Leistung" },
  c_fan: { it: "Ventola", en: "Fan", pl: "Wentylator", uk: "Вентилятор", ru: "Вентилятор", es: "Ventilador", pt: "Ventoinha", de: "Lüfter" }, c_auto: { it: "Auto", en: "Auto", pl: "Auto", uk: "Авто", ru: "Авто", es: "Auto", pt: "Auto", de: "Auto" }, c_man: { it: "Manuale", en: "Manual", pl: "Ręcznie", uk: "Вручну",
  ...
  // hub
  h_open: { it: "Apri Hub", en: "Open Hub", pl: "Otwórz Hub", uk: "Відкрити Hub", ru: "Открыть Hub", es: "Abrir el Hub", pt: "Abrir o Hub", de: "Hub öffnen" }, h_updates: { it: "aggiornamenti", en: "updates", pl: "aktualizacji", uk: "оновлень",
                                                                                                 ru: "обновлений", es: "actualizaciones", pt: "atualizações", de: "Aktualisierungen" },
  // power
  p_reboot: { it: "Riavvia", en: "Reboot", pl: "Uruchom ponownie", uk: "Перезавантажити", ru: "Перезагрузить", es: "Reiniciar", pt: "Reiniciar", de: "Neu starten" }, p_off: { it: "Spegni", en: "Shut down", pl: "Wyłącz", uk: "Вимкнути",
  ...
  p_qreb: { it: "Riavviare la BC-250?", en: "Reboot the BC-250?", pl: "Uruchomić ponownie BC-250?", uk: "Перезавантажити BC-250?",
            ru: "Перезагрузить BC-250?", es: "¿Reiniciar la BC-250?", pt: "Reiniciar a BC-250?", de: "Die BC-250 neu starten?" }, p_qoff: { it: "Spegnere la BC-250?", en: "Shut down the BC-250?", pl: "Wyłączyć BC-250?", uk: "Вимкнути BC-250?",
                                                                                                                                               ru: "Выключить BC-250?", es: "¿Apagar la BC-250?", pt: "Desligar a BC-250?", de: "Die BC-250 herunterfahren?" },
  p_rebing: { it: "Riavvio…", en: "Rebooting…", pl: "Ponowne uruchamianie…", uk: "Перезавантаження…", ru: "Перезагрузка…", es: "Reiniciando…", pt: "Reiniciando…", de: "Wird neu gestartet…" }, p_offing: { it: "Spegnimento…", en: "Shutting down…", pl: "Wyłączanie…", uk: "Вимкнення…",
                                                                                                                    ru: "Выключение…", es: "Apagando…", pt: "Desligando…", de: "Wird heruntergefahren…" },
  // logs / launcher / rec
  l_refresh: { it: "aggiorna", en: "refresh", pl: "odśwież", uk: "оновити", ru: "обновить", es: "actualizar", pt: "atualizar", de: "auffrischen" }, empty: { it: "(vuoto)", en: "(empty)", pl: "(pusto)", uk: "(порожньо)",
  ...
  r_none: { it: "Nessuna registrazione.", en: "No recordings.", pl: "Brak nagrań.", uk: "Немає записів.",
            ru: "Записей нет.", es: "No hay grabaciones.", pt: "Nenhuma gravação.", de: "Keine Aufzeichnungen." }, r_saved: { it: "Registrazione salvata", en: "Recording saved", pl: "Nagranie zapisane", uk: "Запис збережено",
  ...
  k_ready: { it: "Desktop pronto", en: "Desktop ready", pl: "Pulpit gotowy", uk: "Робочий стіл готовий",
             ru: "Рабочий стол готов", es: "Escritorio listo", pt: "Área de trabalho pronta", de: "Arbeitsfläche bereit" }, k_vncpw: { it: "Aperto. Password VNC (se richiesta): ", en: "Opened. VNC password (if asked): ", pl: "Otwarto. Hasło VNC (jeśli zapyta): ", uk: "Відкрито. Пароль VNC (якщо запитає): ",
  ...
  // ai
  ai_engine: { it: "Motore", en: "Engine", pl: "Silnik", uk: "Рушій", ru: "Движок", es: "Motor", pt: "Motor", de: "Motor" }, ai_on: { it: "● acceso", en: "● on", pl: "● wł.", uk: "● увімк.",
                                                                                 ru: "● включён", es: "● encendido", pt: "● ligado", de: "● an" }, ai_off: { it: "○ spento", en: "○ off", pl: "○ wył.", uk: "○ вимк.",
                                                                                                                                                      ru: "○ выключен", es: "○ apagado", pt: "○ desligado", de: "○ aus" },
  ai_start: { it: "▶ Accendi AI", en: "▶ Turn on AI", pl: "▶ Włącz SI", uk: "▶ Увімкнути ШІ", ru: "▶ Включить ИИ", es: "▶ Encender la IA", pt: "▶ Ligar a IA", de: "▶ KI einschalten" }, ai_stop: { it: "■ Spegni AI", en: "■ Turn off AI", pl: "■ Wyłącz SI", uk: "■ Вимкнути ШІ",
  ...
  ai_open: { it: "Apri l’interfaccia ↗", en: "Open the UI ↗", pl: "Otwórz interfejs ↗", uk: "Відкрити інтерфейс ↗",
             ru: "Открыть окно ↗", es: "Abrir la interfaz ↗", pt: "Abrir a interface ↗", de: "Die Oberfläche öffnen ↗" }, ai_ready: { it: "● pronto", en: "● ready", pl: "● gotowy", uk: "● готово",
  ...
  ai_starting: { it: "Avvio AI… (può richiedere un minuto)", en: "Starting AI… (may take a minute)", pl: "Uruchamianie SI… (może potrwać minutę)", uk: "Запуск ШІ… (може зайняти хвилину)",
                 ru: "Запуск ИИ… (может занять минуту)", es: "Arrancando la IA… (puede tardar un minuto)", pt: "Iniciando a IA… (pode levar um minuto)", de: "KI wird gestartet… (kann eine Minute dauern)" }, ai_stopping: { it: "Spengo AI", en: "Stopping AI", pl: "Zatrzymywanie SI", uk: "Зупинка ШІ",
                                                                                                                                                                                                             ru: "Выключаю ИИ", es: "Apagando la IA", pt: "Desligando a IA", de: "KI wird ausgeschaltet" },
  // wol
  w_wol: { it: "Wake-on-LAN", en: "Wake-on-LAN", pl: "Wake-on-LAN", uk: "Wake-on-LAN", ru: "Wake-on-LAN", es: "Wake-on-LAN", pt: "Wake-on-LAN", de: "Wake-on-LAN" }, w_en: { it: "● abilitato", en: "● enabled", pl: "● włączone", uk: "● увімкнено",
                                                                                                 ru: "● включено", es: "● activado", pt: "● ativado", de: "● eingeschaltet" }, w_dis: { it: "○ disabilitato", en: "○ disabled", pl: "○ wyłączone", uk: "○ вимкнено",
                                                                                                                                                                                     ru: "○ выключено", es: "○ desactivado", pt: "○ desativado", de: "○ ausgeschaltet" },
  w_enbtn: { it: "Abilita WoL", en: "Enable WoL", pl: "Włącz WoL", uk: "Увімкнути WoL", ru: "Включить WoL", es: "Activar WoL", pt: "Ativar o WoL", de: "WoL einschalten" }, w_disbtn: { it: "Disabilita WoL", en: "Disable WoL", pl: "Wyłącz WoL", uk: "Вимкнути WoL",
  ...
  w_wake: { it: "Sveglia un altro dispositivo", en: "Wake another device", pl: "Obudź inne urządzenie", uk: "Розбудити інший пристрій",
            ru: "Разбудить другое устройство", es: "Despertar otro dispositivo", pt: "Acordar outro dispositivo", de: "Ein anderes Gerät aufwecken" }, w_send: { it: "Invia", en: "Send", pl: "Wyślij", uk: "Надіслати",
                                                                                                                                                    ru: "Отправить", es: "Enviar", pt: "Enviar", de: "Senden" }, w_sent: { it: "Magic packet inviato", en: "Magic packet sent", pl: "Wysłano magic packet", uk: "Magic packet надіслано",
  ...
  w_sched: { it: "Programma spegnimento/riavvio", en: "Schedule power off/reboot", pl: "Zaplanuj wyłączenie/restart", uk: "Запланувати вимкнення/перезавантаження",
             ru: "Запланировать выключение или перезагрузку", es: "Programar apagado o reinicio", pt: "Agendar desligamento ou reinício", de: "Herunterfahren oder Neustart planen" }, w_cancel: { it: "Annulla", en: "Cancel", pl: "Anuluj", uk: "Скасувати",
  ...
  w_qreb: { it: "Riavviare tra {x} min?", en: "Reboot in {x} min?", pl: "Uruchomić ponownie za {x} min?", uk: "Перезавантажити через {x} хв?",
            ru: "Перезагрузить через {x} мин?", es: "¿Reiniciar dentro de {x} min?", pt: "Reiniciar daqui a {x} min?", de: "In {x} Min. neu starten?" }, w_qoff: { it: "Spegnere tra {x} min?", en: "Shut down in {x} min?", pl: "Wyłączyć za {x} min?", uk: "Вимкнути через {x} хв?",
                                                                                                                                                           ru: "Выключить через {x} мин?", es: "¿Apagar dentro de {x} min?", pt: "Desligar daqui a {x} min?", de: "In {x} Min. herunterfahren?" },
  w_updated: { it: "WoL aggiornato", en: "WoL updated", pl: "Zaktualizowano WoL", uk: "WoL оновлено", ru: "WoL обновлён", es: "WoL actualizado", pt: "WoL atualizado", de: "WoL aktualisiert" }, w_rsched: { it: "Riavvio programmato", en: "Reboot scheduled", pl: "Zaplanowano ponowne uruchomienie", uk: "Перезавантаження заплановано",
                                                                                                                    ru: "Перезагрузка запланирована", es: "Reinicio programado", pt: "Reinício agendado", de: "Neustart geplant" }, w_osched: { it: "Spegnimento programmato", en: "Shutdown scheduled", pl: "Zaplanowano wyłączenie", uk: "Вимкнення заплановано",
                                                                                                                                                                                                                                                                 ru: "Выключение запланировано", es: "Apagado programado", pt: "Desligamento agendado", de: "Herunterfahren geplant" }, w_canc: { it: "Programmazione annullata", en: "Schedule cancelled", pl: "Anulowano plan", uk: "Планування скасовано",
  ...
  ru_thresh: { it: "Soglia", en: "Threshold", pl: "Próg", uk: "Поріг", ru: "Порог", es: "Umbral", pt: "Limite", de: "Schwelle" }, ru_last: { it: "Ultima azione", en: "Last action", pl: "Ostatnia akcja", uk: "Остання дія",
                                                                                    ru: "Последнее действие", es: "Última acción", pt: "Última ação", de: "Letzte Aktion" },
  ru_on: { it: "● attivo", en: "● on", pl: "● wł.", uk: "● увімк.", ru: "● включено", es: "● activa", pt: "● ativa", de: "● an" }, ru_off: { it: "○ spento", en: "○ off", pl: "○ wył.", uk: "○ вимк.",
                                                                                ru: "○ выключено", es: "○ apagada", pt: "○ desligada", de: "○ aus" }, ru_enable: { it: "Attiva", en: "Enable", pl: "Włącz", uk: "Увімкнути",
                                                                                                                                                         ru: "Включить", es: "Activar", pt: "Ativar", de: "Einschalten" }, ru_disable: { it: "Disattiva", en: "Disable", pl: "Wyłącz", uk: "Вимкнути",
                                                                                                                                                                                                                                   ru: "Выключить", es: "Desactivar", pt: "Desativar", de: "Ausschalten" },
  ru_set: { it: "Imposta", en: "Set", pl: "Ustaw", uk: "Встановити", ru: "Задать", es: "Fijar", pt: "Definir", de: "Setzen" }, ru_updated: { it: "Regola aggiornata", en: "Rule updated", pl: "Zaktualizowano regułę", uk: "Правило оновлено",
                                                                                     ru: "Правило обновлено", es: "Regla actualizada", pt: "Regra atualizada", de: "Regel aktualisiert" }, ru_setdone: { it: "Soglia impostata", en: "Threshold set", pl: "Ustawiono próg", uk: "Поріг встановлено",
  ...
  ru_frame: { it: "Ultimo fotogramma dello schermo", en: "Last screen frame", pl: "Ostatnia klatka ekranu", uk: "Останній кадр екрана",
              ru: "Последний кадр экрана", es: "Último fotograma de la pantalla", pt: "Último quadro da tela", de: "Letztes Bild des Bildschirms" }, ru_noframe: { it: "Nessun fotogramma ancora (attiva il modulo e attendi ~20s).", en: "No frame yet (enable the module and wait ~20s).", pl: "Brak klatki (włącz moduł i poczekaj ~20 s).", uk: "Кадру ще немає (увімкніть модуль і зачекайте ~20 с).",
  ...
  ao_none: { it: "(nessuna risposta)", en: "(no answer)", pl: "(brak odpowiedzi)", uk: "(немає відповіді)",
             ru: "(нет ответа)", es: "(sin respuesta)", pt: "(sem resposta)", de: "(keine Antwort)" }, err: { it: "Errore: ", en: "Error: ", pl: "Błąd: ", uk: "Помилка: ",
